 ...
 *   VALUE - Amount in smallest unit (default: 1000 = 0.001 USDC)
 */
...
const VALUE = process.env.VALUE ? BigInt(process.env.VALUE) : 1000n; // 0.001 USDC
...
if (!FROM_PK) {
  ...
  console.error(
    "Usage: FROM_PK=0xYourPrivateKey node test/test-ethereum-sepolia-relay.mjs"
  );
  process.exit(1);
}
